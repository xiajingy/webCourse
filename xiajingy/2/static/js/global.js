  ...
  display: function() {    
	...
	jQuery.getJSON( '/global-banner-message.json?dt=' + dt, function( data ) {
		...
		if ( data.active == 1 ) {
			...
			bannerContent += '<style type="text/css">.ShutdownBanner { background-color: #AC652F; color: #FFFFFF } .ShutdownBanner__Icon svg { position: static; } .ShutdownBanner__Heading { outline: none; } ';
			bannerContent += '.ShutdownBanner__Description a { color: #000000; text-decoration: underline; } .ShutdownBanner__Description a:link { color: #000000; text-decoration: underline; } ';
			...
			if ( shutdown_banner_info_url.length ) {
				bannerContent += '<a href="https://www.nps.gov/acad" title="' + shutdown_banner_title.toLowerCase() + '">Read More<span class="visually-hidden"> about ' + shutdown_banner_title.toLowerCase() + '</span></a>';
			}
        ...
        if (randomInt === testInt) {
          ...
          let vvsMarkup =`
            ...
            <style>
              ...
              div#visitorsSurveyModal2022 div.modal-body-button { width: 170px; margin: auto; margin-top: 20px; }
            ...
            <style media="(min-width: 768px) and (max-width: 991px)">
              ...
              div#visitorsSurveyModal2022 p#OMBNumber { color: #FFF; font-size: 0.8rem; }
            </style>
                  ...
                  <div class="modal-body">
                    <div class="modal-text p-3">
                      ...
                      <div class="modal-body-button">
                        <a href="https://touchpoints.app.cloud.gov/touchpoints/5d71b59f/submit" target="_blank" class="btn btn-primary button-primary -green" style="margin-bottom: 10px">Take a short survey</a>
                      </div>
                    </div>
                  </div>
                  <div class="modal-footer justify-content-between">
                    <small>OMB Control No. 1090-0012</small>
                    <small>Expiration Date: 12/31/2023</small>
                  </div>
                </div>
              </div>
            </div>
